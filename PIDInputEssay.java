...
public class PIDInputEssay
{
  public static void main (String[] args)
  {
    ...
    if (propAction.equalsIgnoreCase("yes")) //receives proportional response
    {
      ...
      ProportionalEssay prop=new ProportionalEssay(kC);
      SignalFromError signal=new SignalFromError;
     
      signal.error()//completer cette partie
    }
    ...
    */
    ...
    double finalSignal=propSignal+intSignal+derivSignal; //ils devraient êtres des arrays comme ca a chaque point on calcule reponse: 
                                                         // gain de l'Actuator*finalSignal et on envoie ca comme etant la variable manipulée
